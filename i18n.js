...
(function(){
  ...
  window.I18N = {
    ru: {
      ...
      backupLocked: "Доступно в полной версии",
      previewLocked: "Предпросмотр доступен в полной версии",
      freeLimitNote: "В бесплатной версии доступны первые 20 слов. Зарегистрируйтесь, чтобы открыть весь словарь.",
    },
    ...
    uk: {
      ...
      backupLocked: "Доступно в повній версії",
      previewLocked: "Перегляд доступний у повній версії",
      freeLimitNote: "У безкоштовній версії доступні перші 20 слів. Зареєструйтеся, щоб відкрити весь словник.",}
  };
